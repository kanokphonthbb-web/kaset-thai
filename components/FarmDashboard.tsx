    ...
    <div className="space-y-6">
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="rounded-2xl bg-mist p-6">
          ...
          <p className="mt-4 text-sm text-stone">
            ราคาสินค้าเกษตรรายวันจากสำนักงานเศรษฐกิจการเกษตร (13 หมวด เช่น สุกร ไข่ไก่ ยางพารา
            ปาล์มน้ำมัน มันสำปะหลัง ข้าวหอมมะลิ) — เปิดดูราคาล่าสุดพร้อมวันที่ของข้อมูลได้ที่หน้าราคา
          </p>
        </div>
