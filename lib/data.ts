...
export const TOOLS: Tool[] = [
  ...
  {
    icon: "📐",
    title: "แปลงหน่วยพื้นที่",
    description: "แปลงไร่ งาน ตารางวา ตารางเมตร เฮกตาร์ เอเคอร์ พร้อมรวมพื้นที่แบบไทย",
    href: "/tools/land-area-converter",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🌳",
    title: "คำนวณจำนวนต้นจากระยะปลูก",
    description: "ใส่พื้นที่และระยะปลูก แล้วดูจำนวนต้นโดยประมาณและต้นต่อไร่",
  ...
  },
  {
    icon: "🧪",
    title: "คำนวณปุ๋ย",
    description: "คำนวณปริมาณปุ๋ย ต้นทุน และธาตุอาหาร N-P-K จากสูตรที่ใช้",
    href: "/tools/fertilizer-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "💧",
    title: "คำนวณน้ำระบบน้ำหยด/สปริงเกอร์",
    description: "คำนวณปริมาณน้ำต่อวัน ต่อเดือน ค่าน้ำ และอัตราไหลรวมของระบบ",
    href: "/tools/irrigation-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "💰",
    title: "คำนวณรายได้-กำไรฟาร์ม",
    description: "ใส่พื้นที่ ผลผลิตต่อไร่ ราคาขาย และต้นทุน ดูกำไรทันที",
    href: "/tools/farm-income-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🌾",
    title: "ประเมินผลผลิตพืช",
    description: "คำนวณผลผลิตจากจำนวนต้นหรือพื้นที่ปลูก พร้อมมูลค่าประมาณ",
    href: "/tools/crop-yield-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🐟",
    title: "คำนวณ FCR อัตราแลกเนื้อ",
    description: "ใส่อาหารและน้ำหนักสัตว์ ดูอัตราแลกเนื้อและต้นทุนอาหาร",
    href: "/tools/fcr-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "⚖️",
    title: "คำนวณจุดคุ้มทุนฟาร์ม",
    description: "ใส่ต้นทุนและผลผลิตที่คาด ดูราคาคุ้มทุนและ ROI",
  ...
  },
  {
    icon: "🌤️",
    title: "หาช่วงฝนน้อย",
    description: "เช็กช่วงฝนน้อยตามข้อมูลพยากรณ์ 48 ชม. ข้างหน้า สำหรับวางแผนงานที่ต้องเลี่ยงฝน",
  ...
  },
  {
    ...
    description: "ดูฝนสะสมตามพยากรณ์ 24/48/72 ชม. และฝนรายวัน 7 วันข้างหน้า รายจังหวัด",
  ...
  },
  {
    ...
    description: "ดูพยากรณ์ 7 วันข้างหน้ารายจังหวัด แยกระดับฝนตามเกณฑ์กรมอุตุฯ ประกอบวางแผนเก็บเกี่ยว",
    href: "/tools/harvest-weather-planner",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🌱",
    title: "คำนวณเมล็ดพันธุ์ต่อไร่",
    description: "ใส่พื้นที่และอัตราเมล็ดพันธุ์ต่อไร่ แล้วดูปริมาณเมล็ดที่ต้องใช้และต้นทุน",
    href: "/tools/seed-rate-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🚰",
    title: "คำนวณขนาดปั๊มน้ำเกษตร",
    description: "ใส่ปริมาณน้ำต่อรอบและชั่วโมงทำงาน แล้วดูอัตราการไหลขั้นต่ำที่ปั๊มต้องทำได้",
    href: "/tools/pump-size-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🧮",
    title: "เปรียบเทียบต้นทุนธาตุอาหารปุ๋ย",
    description: "เปรียบเทียบต้นทุนต่อ กก. ปุ๋ยและต่อ กก. ธาตุอาหาร N-P-K ของปุ๋ยหลายสูตร",
    href: "/tools/fertilizer-cost-comparison",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🥚",
    title: "คำนวณกำไรฟาร์มไก่ไข่",
    description: "ใส่จำนวนแม่ไก่ อัตราไข่ ราคาไข่ และต้นทุนอาหาร แล้วดูกำไรต่อวันและต่อเดือน",
    href: "/tools/egg-farm-profit-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "🥣",
    title: "คำนวณค่าอาหารสัตว์",
    description: "ใช้ได้กับวัว หมู ไก่ ปลา ใส่จำนวนสัตว์และปริมาณอาหาร แล้วดูค่าอาหารรวมและต่อตัว",
    href: "/tools/livestock-feed-cost-calculator",
    status: "พร้อมใช้งาน",
  },
  {
    icon: "☀️",
    title: "ประเมินขนาดแผงโซลาร์สำหรับปั๊มน้ำ",
    description: "ใส่กำลังปั๊ม ชั่วโมงใช้งาน และชั่วโมงแดด แล้วดูขนาดแผงโซลาร์โดยประมาณ",
    href: "/tools/solar-pump-calculator",
    status: "พร้อมใช้งาน",
  },
];
