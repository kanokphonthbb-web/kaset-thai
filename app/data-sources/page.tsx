...
const SOURCES = [
  ...
  {
    name: "NABC Agricultural Data Service — สำนักงานเศรษฐกิจการเกษตร",
    what: "ราคาสินค้าเกษตรรายวัน (13 หมวดสินค้า เช่น สุกร ไข่ไก่ ยางพารา ปาล์มน้ำมัน มันสำปะหลัง ข้าวหอมมะลิ) แยกรายตลาด/จังหวัด ที่แสดงในหน้าราคาสินค้าเกษตร",
    update:
      "ระบบดึงข้อมูลจาก API ของ NABC วันละ 2 รอบ และเก็บเป็นประวัติแบบต่อเนื่อง (ไม่เขียนทับข้อมูลเดิม) ทุกรายการมีวันที่ของแหล่งข้อมูลกำกับ — เว็บไซต์ไม่แสดงราคาสมมติหรือราคาที่แต่งขึ้นเด็ดขาด",
    limits:
      "ราคาเป็นข้อมูลรายวันตามแหล่งข้อมูล ไม่ใช่ราคาซื้อขายแบบเรียลไทม์ ราคาอาจต่างกันตามตลาด/จังหวัด/เกรดสินค้า ช่วงราคาที่แสดงสะท้อนความต่างระหว่างตลาดของวันเดียวกัน",
    link: "https://agriapi.nabc.go.th",
  },
  {
